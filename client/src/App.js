...
function App() {
	...
	return (
		<div className="App">
			<div class="button r center" id="button-4" onClick={handleToggle} >
				...
				{todos.length > 0 ? todos.map(todo => (
					<div class="card">
						...
						<div class="bottom-section">
							<span class="title "><span className='text'>{todo.text}</span></span>
							<div class="row row1">
								<div class="item">
								...
								<div class="item">
									<div className="delete-todo" onClick={EditUser()}><FaEdit></FaEdit></div>
								</div>
								<div class="item">
